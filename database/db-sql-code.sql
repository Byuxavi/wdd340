-- Drop existing types and tables if they exist to allow for clean rebuilds
-- This is important for a database rebuild script
...
-- QUERIES FROM ASSIGNMENT 2 (TASK 1) TO BE INCLUDED IN THE REBUILD SCRIPT:
